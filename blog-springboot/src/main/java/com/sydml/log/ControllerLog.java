...
public class ControllerLog {
     ...
     * 拦截控制层的所有public方法
     */
    @Pointcut("execution(public * com.sydml.controller.*.*(..))")
    public void log() {
    }
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if (!PASS_PATH.contains(requestUri)) {
            ...
            try {
                com.sydml.model.entity.ControllerLog controllerLog = new com.sydml.model.entity.ControllerLog();
